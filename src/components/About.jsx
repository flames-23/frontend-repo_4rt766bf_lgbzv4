      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <p className="text-xs tracking-[0.15em] font-semibold text-blue-600">ABOUT ALCOUNIVERSITY</p>
            <h2 className="mt-3 text-4xl sm:text-5xl font-extrabold tracking-tight text-gray-900">
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-3xl overflow-hidden border border-gray-200 shadow-[0_20px_60px_-20px_rgba(59,130,246,0.3)]">
              <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?q=80&w=1600&auto=format&fit=crop" alt="Students collaborating in a bright lab" className="w-full h-[420px] object-cover" />
